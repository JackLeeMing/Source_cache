(function() {
	...
	a.alias = function(c, b) {
		if (!a.modules.hasOwnProperty(c)) {
			throw new Error('Failed to alias "' + c + '", 文件不存在')
		}
		a.aliases[b] = c
	};
		...
		(function() {
			...
			j = (function(o) {
				...
				n.prototype.defaultOptions = {
					...
					dictFileTooBig: "文件过大 ({{filesize}}MB). 不能超过: {{maxFilesize}}MB.",
					dictInvalidFileType: "您不能上传该类文件.",
					dictResponseError: "服务器错误， 错误码：{{statusCode}}",
					dictCancelUpload: "取消上传",
					dictCancelUploadConfirmation: "确定取消上传?",
					dictRemoveFile: "移除文件",
					dictRemoveFileConfirmation: null,
					dictMaxFilesExceeded: "您只能上传 {{maxFiles}} 个文件.",
					accept: function(r, q) {
						return q()
					},
					init: function() {
